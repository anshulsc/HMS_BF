...
def extract_features_frequency(signal, frame_size, hop_length):
    df_features = {
        'mean': get_mean_freq(signal, frame_size, hop_length),
        'variance': get_variance_freq(signal, frame_size, hop_length),
        'third': get_third_freq(signal, frame_size, hop_length),
        'fourth': get_forth_freq(signal, frame_size, hop_length),
        'grand': get_grand_freq(signal, frame_size, hop_length),
        'std': get_std_freq(signal, frame_size, hop_length),
        'Cfactor': get_Cfactor_freq(signal, frame_size, hop_length),
        'Dfactor': get_Dfactor_freq(signal, frame_size, hop_length),
        'Efactor': get_Efactor_freq(signal, frame_size, hop_length),
        'Gfactor': get_Gfactor_freq(signal, frame_size, hop_length),
        'third1': get_third1_freq(signal, frame_size, hop_length),
        'fourth1': get_forth1_freq(signal, frame_size, hop_length),
        'Hfactor': get_Hfactor_freq(signal, frame_size, hop_length),
        'Jfactor': get_Jfactor_freq(signal, frame_size, hop_length)
    }
